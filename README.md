...
`Fogy` wanted to update other mods with Minimalistic textures style.
...
| branch: [repair](https://github.com/Fogy-F/Minimalistic-GTNH-repair) & [gameUI](https://github.com/Fogy-F/Minimalistic-GTNH-repair/tree/gameUI)
